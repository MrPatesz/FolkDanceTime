        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemSetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSetTransactions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "AdminRoleId", "5da66bd6-a15e-45b2-b759-892813e87544", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "DancerRoleId", "35394b0b-8033-465b-bd17-bb174af931d2", "Dancer", "DANCER" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "0fe9683d-b0b5-4586-b04c-d53c3ee7daab", 0, "de2b07a9-82ce-4f0d-be6f-fc612f9f4ddf", "admin@folkdancetime.com", true, true, null, "ADMIN@FOLKDANCETIME.COM", "ADMIN@FOLKDANCETIME.COM", "AQAAAAEAACcQAAAAEBN98hkpIbddfdTmVa0dJLZ/obxNkglAxhA5yQuUKECq1Xd4/f2ewayXbqst08lVZA==", null, false, "d159d640-b884-4e60-b1f9-e7ed9e78456f", false, "admin@folkdancetime.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "http://schemas.microsoft.com/ws/2008/06/identity/claims/role", "Admin", "0fe9683d-b0b5-4586-b04c-d53c3ee7daab" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "AdminRoleId", "0fe9683d-b0b5-4586-b04c-d53c3ee7daab" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemSetTransactions_ItemSetId",
                table: "ItemSetTransactions",
                column: "ItemSetId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSetTransactions_ReceiverUserId",
                table: "ItemSetTransactions",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSetTransactions_SenderUserId",
                table: "ItemSetTransactions",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemTransactions_ReceiverUserId",
                table: "ItemTransactions",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemTransactions_SenderUserId",
                table: "ItemTransactions",
                column: "SenderUserId");
